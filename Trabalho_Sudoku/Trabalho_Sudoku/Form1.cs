...
namespace Trabalho_Sudoku
{
    public partial class FormPrincipal : Form
    {
        ...
        public FormPrincipal()
        {
            ...
            for (int y = 0; y < 9; y++) //Desenhar grid.
            {
                for (int k = 0; k < 9; k++)
                {
                    //Linhas 0 , 1 e 2
        ...
        private bool Validar(int linha, int coluna)//Função para validar o valor sorteado.
        {            
            ...
            for(int t = linha; t < linha + 3; t++) //Confere se as submatrizes 3x3 contem o valor sorteado.
            {
        ...
        private void GerarNumeros(int linha, int coluna) //Função para gerar o sudoku.
        {
